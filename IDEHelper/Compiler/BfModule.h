...
public:
	...
	BfType* ResolveTypeRef_Type(BfAstNode* astNode, const BfSizedArray<BfGenericArgNode*>* genericArgs, BfPopulateType populateType = BfPopulateType_Data, BfResolveTypeRefFlags resolveFlags = (BfResolveTypeRefFlags)0);
	BfType* ResolveTypeRef(BfAstNode* astNode, const BfSizedArray<BfGenericArgNode*>* genericArgs, BfPopulateType populateType = BfPopulateType_Data, BfResolveTypeRefFlags resolveFlags = (BfResolveTypeRefFlags)0);
